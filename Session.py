...
class Session:
    ...
    # classmethod to ensure that the Session uses raw dictionaries.
    # We do not want callers to loop and call on add_observation() in a Session.
    @classmethod
    ...
    def rejected_count(self):
        return len(self.rejected_observations) # return the number of rejected observations.
